...
summary: "Industry-engagement project for YatrikiSoft: PyTorch STGNN with federated learning across retail silos, causal attribution via SHAP + DoWhy, and adaptive inventory replenishment via Ray RLlib. 14.2% → 11.1% MAPE across 4,200 SKUs."
bullets:
